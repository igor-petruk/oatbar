...
use crate::parse::{DeserializeFields, ExpressionProcessor, Field, Final, Input};
// use crate::source;
...
pub struct DisplayOptions<S: Clone + Default> {
    pub font: Field<S, String>,
    pub foreground: Field<S, String>,
    pub value: Field<S, String>,
    pub popup_value: Field<S, String>,
    pub background: Field<S, String>,
    pub overline_color: Field<S, String>,
    pub underline_color: Field<S, String>,
    pub edgeline_color: Field<S, String>,
    pub pango_markup: Option<bool>,
    pub margin: Field<S, f64>,
    pub padding: Field<S, f64>,
    pub line_width: Field<S, f64>,
    pub show_if_set: Field<S, String>, // Bool?
...
#[derive(Debug, Clone, Deserialize, Default)]
#[serde(default)]
pub struct DefaultBlock<S: Clone> {
    #[serde(flatten)]
...
pub fn load() -> anyhow::Result<Config<Input>> {
    ...
    let config: Config<Input> = toml::from_str(&data)?;
