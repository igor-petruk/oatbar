...
- **MCP Server Integration**: A powerful new **Model Context Protocol (MCP)** server allows AI agents to interact directly with your status bar, reporting status and setting variables. You can configure your bar with the help of MCP because your agent has access to configs and data.
